...
$sql = "SELECT * FROM managers WHERE cod_man='$data'";
...
$aldatu="UPDATE managers SET phone='$phone',name='$name',details='$details' WHERE cod_man='$data'";
mysql_query($aldatu);
header("Refresh:0");
}
mysql_close($dp);
?>
<br/>
<a href="manage_managers.php" style="text-decoration:none"><input type="button" value="Back"></a>
</div>
