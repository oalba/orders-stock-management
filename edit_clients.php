...
$sql = "SELECT * FROM clients WHERE cod_cli='$data'";
...
$aldatu="UPDATE clients SET phone='$phone',name='$name',details='$details' WHERE cod_cli='$data'";
mysql_query($aldatu);
header("Refresh:0");
}
mysql_close($dp);
?>
<br/>
<a href="manage_clients.php" style="text-decoration:none"><input type="button" value="Back"></a>
</div>
